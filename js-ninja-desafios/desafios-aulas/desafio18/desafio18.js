(function() {
    ...
    */
    ...
    var cleanCPFRegex = /(\d{3})(\d{3})(\d{3})(\d{2})/;
    function formataCPF(regex, primeiros3, segundos3, terceiros3, digito) {
        return primeiros3 + '.' + segundos3 + '.' + terceiros3 + '-' + digito;
    }
    console.log(cleanCPF('049-214 3421-1').replace(cleanCPFRegex, formataCPF));
    console.log(cleanCPF('210.458.522-05').replace(cleanCPFRegex, formataCPF));
    console.log(cleanCPF('735 500 794 - 22').replace(cleanCPFRegex, formataCPF));
    console.log(cleanCPF('101.123-131x32').replace(cleanCPFRegex, formataCPF));
    ...
    */
    ...
    function removeSimbolos(abertura) {
        return abertura.replace(/\W/g, '');
    }
