(function() {
    ...
    */
    ...
    var hasMoreThanSevenLetters = brasil.every(function(item, index, array) {
        return item.length > 7;
    });
    if(hasMoreThanSevenLetters === true) {
    ...
    */
    var map = newBrasil.map(function(item, index, array) {
        var id = item.id + 1;
        var estado = item.estado + ' pertence ao Brasil.';
