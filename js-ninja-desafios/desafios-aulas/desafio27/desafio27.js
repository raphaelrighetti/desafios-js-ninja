...
DOM.prototype.reduce = function reduce(func, current) {
    return Array.prototype.reduce.call(this.element, func, current);
}
DOM.prototype.reduceRight = function reduceRight(func, current) {
    return Array.prototype.reduceRight.call(this.element, func, current);
}
